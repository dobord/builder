...
class StrictQualificationWorkflowTests(unittest.TestCase):
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('ref: a87950eb71feeea3d29c16610894f94007786dd6',workflow)
        ...
        self.assertIn('VCPKG = "a87950eb71feeea3d29c16610894f94007786dd6"',worker)
        self.assertNotIn('SDK_VCPKG =',worker)
        self.assertNotIn('verify_engine_registry_delta(',worker)
        self.assertIn('CEF = "8545a10c99f2ede0f08e75cda7c054aed424f4f5"',worker)
        ...
        self.assertIn('"vcpkg_commit": "a87950eb71feeea3d29c16610894f94007786dd6"',lock)
        self.assertIn('"cef_recipe_commit": "8545a10c99f2ede0f08e75cda7c054aed424f4f5"',lock)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ENGINE_VCPKG = "9cd6130b3e9d1c7b8d055dde4de9c420dc8af305"',worker)
        self.assertIn('SDK_VCPKG = "9cd6130b3e9d1c7b8d055dde4de9c420dc8af305"',worker)
        ...
        self.assertIn('CEF = "5a5df2f35afabbc2177dd2724400f56b4b6003d3"',worker)
    ...
    def test_windows_engine_iteration_is_dormant_encrypted_and_exact(self):
        ...
        self.assertIn("ref: 9cd6130b3e9d1c7b8d055dde4de9c420dc8af305", workflow)
        self.assertIn("ref: 5a5df2f35afabbc2177dd2724400f56b4b6003d3", workflow)
        self.assertIn("cef-windows-engine-checkpoint-encrypted/*.enc", workflow)
        self.assertNotIn("cef-windows-engine-work/**", workflow)
        self.assertIn('VCPKG = "9cd6130b3e9d1c7b8d055dde4de9c420dc8af305"', worker)
        self.assertIn('CEF = "5a5df2f35afabbc2177dd2724400f56b4b6003d3"', worker)
        ...
        self.assertIn('"vcpkg_commit": "9cd6130b3e9d1c7b8d055dde4de9c420dc8af305"', lock)
        self.assertIn('"cef_recipe_commit": "5a5df2f35afabbc2177dd2724400f56b4b6003d3"', lock)
        self.assertIn('"checkpoint": null', lock)
    ...
    def test_windows_msvc_stl_full_source_gate_builds_lfc_ui_example(self):
        ...
        self.assertIn("ref: 5a5df2f35afabbc2177dd2724400f56b4b6003d3", text)
        self.assertIn("ref: 9cd6130b3e9d1c7b8d055dde4de9c420dc8af305", text)
    ...
    def test_freerdp_static_diagnostic_uses_deterministic_audio_revision(self):
        ...
        self.assertIn("ref: 419ab004bef3b0ef9cfdf661eef9ac5136f5d2a7", text)

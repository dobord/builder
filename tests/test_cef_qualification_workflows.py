...
class StrictQualificationWorkflowTests(unittest.TestCase):
    ...
    def test_windows_engine_iteration_is_dormant_encrypted_and_exact(self):
        ...
        self.assertIn("group: cef-windows-engine-iteration-28c00c60", workflow)
        ...
        self.assertIn("ref: 57d5564b8e4aabd707f5b69a41153e67c68e6ebb", workflow)
        self.assertIn("ref: 28c00c60b52fdb9d5fefc34f8ae8484aa3e7ff11", workflow)
        self.assertIn("cef-windows-engine-checkpoint-encrypted/*.enc", workflow)
        self.assertNotIn("cef-windows-engine-work/**", workflow)
        self.assertIn('VCPKG = "57d5564b8e4aabd707f5b69a41153e67c68e6ebb"', worker)
        self.assertIn('CEF = "28c00c60b52fdb9d5fefc34f8ae8484aa3e7ff11"', worker)
        ...
        self.assertIn('"vcpkg_commit": "57d5564b8e4aabd707f5b69a41153e67c68e6ebb"', lock)
        self.assertIn('"cef_recipe_commit": "28c00c60b52fdb9d5fefc34f8ae8484aa3e7ff11"', lock)
        self.assertIn('"checkpoint": null', lock)
    ...
    def test_windows_msvc_stl_full_source_gate_builds_lfc_ui_example(self):
        ...
        self.assertIn("group: cef-windows-msvc-stl-source-build-28c00c60", text)

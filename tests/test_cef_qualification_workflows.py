...
class StrictQualificationWorkflowTests(unittest.TestCase):
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ref: 60c9e0c043702334036d1b7b8b8cd67c97318da2',text)
        ...
        self.assertIn('SDK_VCPKG = "60c9e0c043702334036d1b7b8b8cd67c97318da2"',worker)
    ...
    def test_lfc_ui_freerdp_regression_workflow_is_relocated_and_static(self):
        ...
        self.assertIn("LFC_UI_FREERDP_UNEXPECTED_MEDIA_GRAPH", text)
        self.assertIn("grep -Eq '^Package: (ffmpeg|libdvdcss)$'", text)
        self.assertIn("export lfc-ui freerdp", text)
        self.assertNotIn("export lfc-ui freerdp ffmpeg", text)
        self.assertIn("category=", text)

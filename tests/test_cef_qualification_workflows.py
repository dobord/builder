...
class StrictQualificationWorkflowTests(unittest.TestCase):
    def test_full_platform_workflow_is_exact_and_keeps_native_output_private(self):
        ...
        self.assertIn("ref: eca827d50971a1acc1a7f44a85108e22c302decd", text)
        ...
        self.assertIn("ref: df861f0ea6ac7c950c3e20689f38817ba7889bde", text)
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('ref: eca827d50971a1acc1a7f44a85108e22c302decd',workflow)
        ...
        self.assertIn('VCPKG = "eca827d50971a1acc1a7f44a85108e22c302decd"',worker)
        self.assertIn('CEF = "df861f0ea6ac7c950c3e20689f38817ba7889bde"',worker)
        ...
        self.assertIn('"vcpkg_commit": "eca827d50971a1acc1a7f44a85108e22c302decd"',lock)

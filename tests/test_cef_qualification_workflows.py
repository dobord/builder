...
class StrictQualificationWorkflowTests(unittest.TestCase):
    def test_full_platform_workflow_is_exact_and_keeps_native_output_private(self):
        ...
        self.assertIn("ref: 7f94dfb9b68df553983e5fa1533c9944ba7e1d03", text)
        ...
        self.assertIn("ref: 9e8635f138ac43b62014da44fd102a9200cf44a1", text)
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('ref: 7f94dfb9b68df553983e5fa1533c9944ba7e1d03',workflow)
        ...
        self.assertIn('VCPKG = "7f94dfb9b68df553983e5fa1533c9944ba7e1d03"',worker)
        self.assertNotIn('SDK_VCPKG =',worker)
        self.assertNotIn('verify_engine_registry_delta(',worker)
        self.assertIn('CEF = "9e8635f138ac43b62014da44fd102a9200cf44a1"',worker)
        ...
        self.assertIn('"cef_recipe_commit": "9e8635f138ac43b62014da44fd102a9200cf44a1"',lock)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ENGINE_VCPKG = "7f94dfb9b68df553983e5fa1533c9944ba7e1d03"',worker)
        self.assertIn('SDK_VCPKG = "7f94dfb9b68df553983e5fa1533c9944ba7e1d03"',worker)
    ...
    def test_windows_engine_iteration_is_dormant_encrypted_and_exact(self):
        ...
        self.assertIn("ref: 114592cf5595131f9bd968e1afd1f2c575f2301c", workflow)
        self.assertIn("ref: 8cc991137287ca18e989e2bb292e2323ba052b28", workflow)
        self.assertIn("cef-windows-engine-checkpoint-encrypted/*.enc", workflow)
        self.assertNotIn("cef-windows-engine-work/**", workflow)
        self.assertIn('VCPKG = "114592cf5595131f9bd968e1afd1f2c575f2301c"', worker)
        self.assertIn('CEF = "8cc991137287ca18e989e2bb292e2323ba052b28"', worker)
        ...
        self.assertIn('"vcpkg_commit": "114592cf5595131f9bd968e1afd1f2c575f2301c"', lock)
        self.assertIn('"cef_recipe_commit": "8cc991137287ca18e989e2bb292e2323ba052b28"', lock)
        self.assertIn('"checkpoint": null', lock)
    ...
    def test_windows_msvc_stl_full_source_gate_builds_lfc_ui_example(self):
        ...
        self.assertIn("ref: 8cc991137287ca18e989e2bb292e2323ba052b28", text)
        self.assertIn("ref: 114592cf5595131f9bd968e1afd1f2c575f2301c", text)

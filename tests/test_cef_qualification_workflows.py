...
class StrictQualificationWorkflowTests(unittest.TestCase):
    def test_full_platform_workflow_is_exact_and_keeps_native_output_private(self):
        ...
        self.assertIn("ref: ba7efc391ec56c717ae4bfda839286b52eca1559", text)
        ...
        self.assertIn("ref: 28c00c60b52fdb9d5fefc34f8ae8484aa3e7ff11", text)
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('ref: ba7efc391ec56c717ae4bfda839286b52eca1559',workflow)
        ...
        self.assertIn('VCPKG = "ba7efc391ec56c717ae4bfda839286b52eca1559"',worker)
        self.assertNotIn('SDK_VCPKG =',worker)
        self.assertNotIn('verify_engine_registry_delta(',worker)
        self.assertIn('CEF = "28c00c60b52fdb9d5fefc34f8ae8484aa3e7ff11"',worker)
        ...
        self.assertIn('"vcpkg_commit": "ba7efc391ec56c717ae4bfda839286b52eca1559"',lock)
        self.assertIn('"cef_recipe_commit": "28c00c60b52fdb9d5fefc34f8ae8484aa3e7ff11"',lock)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ENGINE_VCPKG = "ba7efc391ec56c717ae4bfda839286b52eca1559"',worker)
        self.assertIn('SDK_VCPKG = "ba7efc391ec56c717ae4bfda839286b52eca1559"',worker)
    ...
    def test_windows_engine_iteration_is_dormant_encrypted_and_exact(self):
        ...
        self.assertIn("ref: 0dc4c581aef8c06a7f7a570b2be93e91072f6fcf", workflow)
        self.assertIn("ref: a7c1b48415a69b095aa329b1cad443948fad4c82", workflow)
        self.assertIn("cef-windows-engine-checkpoint-encrypted/*.enc", workflow)
        self.assertNotIn("cef-windows-engine-work/**", workflow)
        self.assertIn('VCPKG = "0dc4c581aef8c06a7f7a570b2be93e91072f6fcf"', worker)
        self.assertIn('CEF = "a7c1b48415a69b095aa329b1cad443948fad4c82"', worker)
        ...
        self.assertIn('"vcpkg_commit": "0dc4c581aef8c06a7f7a570b2be93e91072f6fcf"', lock)
        self.assertIn('"cef_recipe_commit": "a7c1b48415a69b095aa329b1cad443948fad4c82"', lock)
        self.assertIn('"checkpoint": null', lock)
    ...
    def test_windows_msvc_stl_full_source_gate_builds_lfc_ui_example(self):
        ...
        self.assertIn("ref: a7c1b48415a69b095aa329b1cad443948fad4c82", text)
        self.assertIn("ref: 0dc4c581aef8c06a7f7a570b2be93e91072f6fcf", text)

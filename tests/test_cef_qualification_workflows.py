...
class StrictQualificationWorkflowTests(unittest.TestCase):
    def test_full_platform_workflow_is_exact_and_keeps_native_output_private(self):
        ...
        self.assertIn("ref: 5556ced2e671509c1dce8a19fd3b709cf748acb6", text)
        ...
        self.assertIn("ref: c7eb018bc78a7d278df6ed53ff93544ea2cdb3e7", text)
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('ref: 5556ced2e671509c1dce8a19fd3b709cf748acb6',workflow)
        ...
        self.assertIn('VCPKG = "5556ced2e671509c1dce8a19fd3b709cf748acb6"',worker)
        self.assertNotIn('SDK_VCPKG =',worker)
        self.assertNotIn('verify_engine_registry_delta(',worker)
        self.assertIn('CEF = "c7eb018bc78a7d278df6ed53ff93544ea2cdb3e7"',worker)
        ...
        self.assertIn('"vcpkg_commit": "5556ced2e671509c1dce8a19fd3b709cf748acb6"',lock)
        self.assertIn('"cef_recipe_commit": "c7eb018bc78a7d278df6ed53ff93544ea2cdb3e7"',lock)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ENGINE_VCPKG = "5556ced2e671509c1dce8a19fd3b709cf748acb6"',worker)
        self.assertIn('SDK_VCPKG = "5556ced2e671509c1dce8a19fd3b709cf748acb6"',worker)
    ...
    def test_windows_engine_iteration_is_dormant_encrypted_and_exact(self):
        ...
        self.assertIn("ref: 5556ced2e671509c1dce8a19fd3b709cf748acb6", workflow)
        self.assertIn("ref: c7eb018bc78a7d278df6ed53ff93544ea2cdb3e7", workflow)

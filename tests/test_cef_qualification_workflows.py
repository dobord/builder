...
class StrictQualificationWorkflowTests(unittest.TestCase):
    def test_full_platform_workflow_is_exact_and_keeps_native_output_private(self):
        ...
        self.assertIn("ref: 6bc7ecd4dcfcea6caeedb209b67627aa4deb1564", text)
        ...
        self.assertIn("ref: 0d3ebf395343d584e2c0ed266c5b3b61063de30c", text)
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('ref: 6bc7ecd4dcfcea6caeedb209b67627aa4deb1564',workflow)
        ...
        self.assertIn('VCPKG = "6bc7ecd4dcfcea6caeedb209b67627aa4deb1564"',worker)
        self.assertNotIn('SDK_VCPKG =',worker)
        self.assertNotIn('verify_engine_registry_delta(',worker)
        self.assertIn('CEF = "0d3ebf395343d584e2c0ed266c5b3b61063de30c"',worker)
        ...
        self.assertIn('"vcpkg_commit": "6bc7ecd4dcfcea6caeedb209b67627aa4deb1564"',lock)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ENGINE_VCPKG = "6bc7ecd4dcfcea6caeedb209b67627aa4deb1564"',worker)
        self.assertIn('SDK_VCPKG = "6bc7ecd4dcfcea6caeedb209b67627aa4deb1564"',worker)
    ...
    def test_windows_engine_iteration_is_dormant_encrypted_and_exact(self):
        ...
        self.assertIn("ref: 6bc7ecd4dcfcea6caeedb209b67627aa4deb1564", workflow)
        self.assertIn("ref: 0d3ebf395343d584e2c0ed266c5b3b61063de30c", workflow)
        ...
        self.assertIn('"vcpkg_commit": "6bc7ecd4dcfcea6caeedb209b67627aa4deb1564"', lock)
        self.assertIn('"cef_recipe_commit": "0d3ebf395343d584e2c0ed266c5b3b61063de30c"', lock)
        self.assertIn('"checkpoint": null', lock)

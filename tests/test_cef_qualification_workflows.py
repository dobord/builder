...
class StrictQualificationWorkflowTests(unittest.TestCase):
    def test_full_platform_workflow_is_exact_and_keeps_native_output_private(self):
        ...
        self.assertIn("group: cef-strict-platform-qualification-5556ced2", text)
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('group: cef-strict-engine-linux-5556ced2',workflow)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ENGINE_VCPKG = "e9c09478ea2ea57e65688d3477de04f774bd39d4"',worker)
        self.assertIn('SDK_VCPKG = "e9c09478ea2ea57e65688d3477de04f774bd39d4"',worker)
    ...
    def test_current_private_source_contract_workflow_pins_gn_gate_revision(self):
        ...
        self.assertIn("repository: dobord/vcpkg", text)
        self.assertIn("ref: 5476b6c19e7b75b9e680d7498c10a25f734f5b50", text)
        self.assertIn("ref: f47b91a00003f9a230f9182fc61d1d8739a720c1", text)

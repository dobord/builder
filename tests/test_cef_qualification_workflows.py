...
class StrictQualificationWorkflowTests(unittest.TestCase):
    def test_full_platform_workflow_is_exact_and_keeps_native_output_private(self):
        ...
        self.assertIn("group: cef-strict-platform-qualification-18567956", text)
        self.assertIn("ref: 18567956f7595df7936881b93c9d12028c204dc7", text)
        ...
        self.assertIn("ref: ff9276b9de9361ddeaa5b53589e79e17c254d2f4", text)
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('ref: 18567956f7595df7936881b93c9d12028c204dc7',workflow)
        self.assertIn('run: python -m secure_release.cef_strict_iteration',workflow)
        self.assertIn('group: cef-strict-engine-linux-18567956',workflow)
        ...
        self.assertIn('VCPKG = "18567956f7595df7936881b93c9d12028c204dc7"',worker)
        self.assertNotIn('SDK_VCPKG =',worker)
        self.assertNotIn('verify_engine_registry_delta(',worker)
        self.assertIn('CEF = "ff9276b9de9361ddeaa5b53589e79e17c254d2f4"',worker)
        ...
        self.assertIn('"vcpkg_commit": "18567956f7595df7936881b93c9d12028c204dc7"',lock)
        self.assertIn('"cef_recipe_commit": "ff9276b9de9361ddeaa5b53589e79e17c254d2f4"',lock)
    ...
    def test_sdk_dependency_qualification_keeps_private_build_logs_runner_local(self):
        ...
        self.assertIn("ref: e9c09478ea2ea57e65688d3477de04f774bd39d4", text)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ENGINE_VCPKG = "18567956f7595df7936881b93c9d12028c204dc7"',worker)
        self.assertIn('SDK_VCPKG = "18567956f7595df7936881b93c9d12028c204dc7"',worker)
    ...
    def test_windows_engine_iteration_is_dormant_encrypted_and_exact(self):
        ...
        self.assertIn("group: cef-windows-engine-iteration-5556ced2", workflow)
        ...
        self.assertIn("ref: e9c09478ea2ea57e65688d3477de04f774bd39d4", workflow)
        self.assertIn("ref: f47b91a00003f9a230f9182fc61d1d8739a720c1", workflow)
        self.assertIn("cef-windows-engine-checkpoint-encrypted/*.enc", workflow)
        self.assertNotIn("cef-windows-engine-work/**", workflow)
        self.assertIn('VCPKG = "e9c09478ea2ea57e65688d3477de04f774bd39d4"', worker)
        self.assertIn('CEF = "f47b91a00003f9a230f9182fc61d1d8739a720c1"', worker)
        ...
        self.assertIn('"vcpkg_commit": "e9c09478ea2ea57e65688d3477de04f774bd39d4"', lock)
        self.assertIn('"cef_recipe_commit": "f47b91a00003f9a230f9182fc61d1d8739a720c1"', lock)
        self.assertIn('"checkpoint": null', lock)
    ...
    def test_windows_msvc_stl_full_source_gate_builds_lfc_ui_example(self):
        ...
        self.assertIn("ref: f47b91a00003f9a230f9182fc61d1d8739a720c1", text)
        self.assertIn("ref: e9c09478ea2ea57e65688d3477de04f774bd39d4", text)
        self.assertIn("source_build.py build", text)
        self.assertIn("group: cef-windows-msvc-stl-source-build-5556ced2", text)

...
class StrictQualificationWorkflowTests(unittest.TestCase):
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('ref: 1669f647f46fc6eaa9f73fcbb0ff79857b780071',workflow)
        ...
        self.assertIn('VCPKG = "1669f647f46fc6eaa9f73fcbb0ff79857b780071"',worker)
        ...
        self.assertIn('"vcpkg_commit": "1669f647f46fc6eaa9f73fcbb0ff79857b780071"',lock)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ENGINE_VCPKG = "1669f647f46fc6eaa9f73fcbb0ff79857b780071"',worker)
        self.assertIn('SDK_VCPKG = "1669f647f46fc6eaa9f73fcbb0ff79857b780071"',worker)
    ...
    def test_windows_engine_iteration_is_dormant_encrypted_and_exact(self):
        ...
        self.assertIn("group: cef-windows-engine-iteration-c7eb018b", workflow)
    ...
    def test_windows_msvc_stl_full_source_gate_builds_lfc_ui_example(self):
        ...
        self.assertIn("group: cef-windows-msvc-stl-source-build-c7eb018b", text)

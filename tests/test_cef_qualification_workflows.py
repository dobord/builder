...
class StrictQualificationWorkflowTests(unittest.TestCase):
    def test_full_platform_workflow_is_exact_and_keeps_native_output_private(self):
        ...
        self.assertIn("ref: d1c76dcfd2c5c8715942ceea7270a4732d31a3cd", text)
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('ref: 52bef1a3c2bfef7d20f2ad9f7f9ce86ad7a91534',workflow)
        ...
        self.assertIn('VCPKG = "52bef1a3c2bfef7d20f2ad9f7f9ce86ad7a91534"',worker)
        self.assertNotIn('SDK_VCPKG =',worker)
        self.assertNotIn('verify_engine_registry_delta(',worker)
        self.assertIn('CEF = "d1c76dcfd2c5c8715942ceea7270a4732d31a3cd"',worker)
        ...
        self.assertIn('"vcpkg_commit": "52bef1a3c2bfef7d20f2ad9f7f9ce86ad7a91534"',lock)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ENGINE_VCPKG = "52bef1a3c2bfef7d20f2ad9f7f9ce86ad7a91534"',worker)
        self.assertIn('SDK_VCPKG = "52bef1a3c2bfef7d20f2ad9f7f9ce86ad7a91534"',worker)
    ...
    def test_windows_engine_iteration_is_dormant_encrypted_and_exact(self):
        ...
        self.assertIn("ref: 52bef1a3c2bfef7d20f2ad9f7f9ce86ad7a91534", workflow)
        self.assertIn("ref: d1c76dcfd2c5c8715942ceea7270a4732d31a3cd", workflow)
        ...
        self.assertIn('"vcpkg_commit": "52bef1a3c2bfef7d20f2ad9f7f9ce86ad7a91534"', lock)
        self.assertIn('"cef_recipe_commit": "d1c76dcfd2c5c8715942ceea7270a4732d31a3cd"', lock)
        self.assertIn('"checkpoint": null', lock)

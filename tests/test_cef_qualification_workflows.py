...
class StrictQualificationWorkflowTests(unittest.TestCase):
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('"run": 35602399862',lock)
        self.assertIn('"artifact_id": 10642896558',lock)
        self.assertIn('"summary_artifact_id": 10642366669',lock)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('- ci/cef-strict-combined-lock.json',text)
        self.assertIn('ref: f693b42b65e6449310754b1dd2cacc402fea558f',text)
        ...
        self.assertIn('SDK_VCPKG = "f693b42b65e6449310754b1dd2cacc402fea558f"',worker)

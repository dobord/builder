...
class StrictQualificationWorkflowTests(unittest.TestCase):
    def test_full_platform_workflow_is_exact_and_keeps_native_output_private(self):
        ...
        self.assertIn("ref: 1873bb62072b2b2d89a5bd2257271cd2fbab8fd4", text)
        ...
        self.assertIn("ref: e3408e6a451698aeb922dc4147ec665d432e7f0a", text)
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('ref: 1873bb62072b2b2d89a5bd2257271cd2fbab8fd4',workflow)
        ...
        self.assertIn('VCPKG = "1873bb62072b2b2d89a5bd2257271cd2fbab8fd4"',worker)
        self.assertNotIn('SDK_VCPKG =',worker)
        self.assertNotIn('verify_engine_registry_delta(',worker)
        self.assertIn('CEF = "e3408e6a451698aeb922dc4147ec665d432e7f0a"',worker)
        ...
        self.assertIn('"vcpkg_commit": "1873bb62072b2b2d89a5bd2257271cd2fbab8fd4"',lock)
        self.assertIn('"cef_recipe_commit": "e3408e6a451698aeb922dc4147ec665d432e7f0a"',lock)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ENGINE_VCPKG = "1873bb62072b2b2d89a5bd2257271cd2fbab8fd4"',worker)
        self.assertIn('SDK_VCPKG = "1873bb62072b2b2d89a5bd2257271cd2fbab8fd4"',worker)
    ...
    def test_windows_engine_iteration_is_dormant_encrypted_and_exact(self):
        ...
        self.assertIn("ref: 1873bb62072b2b2d89a5bd2257271cd2fbab8fd4", workflow)
        self.assertIn("ref: e3408e6a451698aeb922dc4147ec665d432e7f0a", workflow)
    ...
    def test_current_private_source_contract_workflow_pins_gn_gate_revision(self):
        ...
        self.assertIn("repository: dobord/vcpkg", text)
        self.assertIn("ref: c8cb75c131c31640537f61879e5c391fa031dbfc", text)
        self.assertIn("ref: e3408e6a451698aeb922dc4147ec665d432e7f0a", text)

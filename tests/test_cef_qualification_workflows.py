...
class StrictQualificationWorkflowTests(unittest.TestCase):
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('"run": 35597116664',lock)
        self.assertIn('"artifact_id": 10638522869',lock)
        self.assertIn('"summary_artifact_id": 10638587773',lock)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('- ci/cef-strict-combined-lock.json',text)
        self.assertIn('ref: bf68c0cf323ff98dcf5340dda5d92e80b7f1f681',text)
        ...
        self.assertIn('SDK_VCPKG = "bf68c0cf323ff98dcf5340dda5d92e80b7f1f681"',worker)
        ...
        self.assertIn('CEF = "2aff22e09daaa5c28780c5766a70ee13e61c93b6"',worker)
        self.assertIn('LFC_UI = "34849ac3ad69471d811ea889060c6a602291db28"',worker)
    ...
    def test_lfc_ui_freerdp_regression_workflow_is_relocated_and_static(self):
        ...
        self.assertIn("ref: 34849ac3ad69471d811ea889060c6a602291db28", text)

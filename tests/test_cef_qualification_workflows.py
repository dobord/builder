...
class StrictQualificationWorkflowTests(unittest.TestCase):
    def test_full_platform_workflow_is_exact_and_keeps_native_output_private(self):
        ...
        self.assertIn("ref: 034a94f6b57c9e0aaa8722401c2d7f6ddc055e03", text)
    ...
    def test_strict_engine_iteration_uploads_only_encrypted_checkpoint(self):
        ...
        self.assertIn('ref: 034a94f6b57c9e0aaa8722401c2d7f6ddc055e03',workflow)
        ...
        self.assertIn('VCPKG = "034a94f6b57c9e0aaa8722401c2d7f6ddc055e03"',worker)
        ...
        self.assertIn('"vcpkg_commit": "034a94f6b57c9e0aaa8722401c2d7f6ddc055e03"',lock)
    ...
    def test_combined_qualification_runs_only_for_explicit_checkpoint_lock(self):
        ...
        self.assertIn('ENGINE_VCPKG = "034a94f6b57c9e0aaa8722401c2d7f6ddc055e03"',worker)
        self.assertIn('SDK_VCPKG = "034a94f6b57c9e0aaa8722401c2d7f6ddc055e03"',worker)
